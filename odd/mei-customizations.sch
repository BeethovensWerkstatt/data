...
<sch:schema queryBinding="xslt2" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:let name="mei.source.path" value="'https://raw.githubusercontent.com/music-encoding/music-encoding/develop/source/mei-source.xml'"/>
    ...
    <sch:pattern id="check_att_classSpecs">
        <sch:rule context="tei:classSpec[@type = 'atts']">
            ...
            <sch:assert test="$exists or @mode = 'add'">There is no attribute class with name "<sch:value-of select="$ident"/>".</sch:assert>
    ...
    <sch:pattern id="check_model_classSpecs">
        <sch:rule context="tei:classSpec[@type = 'model']">
            ...
            <sch:assert test="$exists or @mode = 'add'">There is no model class with name "<sch:value-of select="$ident"/>".</sch:assert>
